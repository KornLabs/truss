...
> Dies ist die deutsche Übersetzung der [englischen README](README.md) (Stand: `1.0.0-rc.1`). Bei Abweichungen ist die englische Version maßgeblich.
...
git clone --depth 1 --branch v1.0.0-rc.1 https://github.com/KornLabs/truss.git /tmp/truss
...
git clone --depth 1 --branch v1.0.0-rc.1 https://github.com/KornLabs/truss.git $env:TEMP\truss
...
`1.0.0-rc.1` — Alpha, und die Versionsnummer ist der ehrliche Teil.
