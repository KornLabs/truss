...
> Dies ist die deutsche Übersetzung der [englischen README](README.md) (Stand: `1.0.0-beta.1`). Bei Abweichungen ist die englische Version maßgeblich.
...
`1.0.0-beta.1` — Alpha, und die Versionsnummer ist der ehrliche Teil.
