...
> Dies ist die deutsche Übersetzung der [englischen README](README.md) (Stand: `1.0.0-beta.2`). Bei Abweichungen ist die englische Version maßgeblich.
...
`1.0.0-beta.2` — Alpha, und die Versionsnummer ist der ehrliche Teil.
