...
git clone --depth 1 --branch v1.0.0-beta.2 https://github.com/KornLabs/truss.git /tmp/truss
...
git clone --depth 1 --branch v1.0.0-beta.2 https://github.com/KornLabs/truss.git $env:TEMP\truss
...
`1.0.0-beta.2` — alpha, and the version number is the honest part.
