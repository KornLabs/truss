...
Every subagent you spawn inherits your active preferences and the current phase's forbidden list / `forbidden-globs`, and must re-check the phase gate before writing any forbidden path (e.g. `repo/**`) — recursively. This is the canonical inheritance rule in AGENTS.md §5; enforce it on every package you delegate.
