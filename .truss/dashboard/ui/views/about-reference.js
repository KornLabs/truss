...
const PREFS = [
  ...
  { key: 'gate-advocate', values: 'off · on', def: 'on' },
...
const CHECKS = [
  ...
  { id: 'SY-01', sev: 'E', desc: 'Required key missing in a state file' },
  { id: 'SY-02', sev: 'W', desc: 'State file is empty or has only boilerplate' },
  { id: 'SY-03', sev: 'W', desc: 'current.md has not been updated recently (stale)' },
  { id: 'SY-04', sev: 'W', desc: 'Legacy format detected (migration nudge)' },
