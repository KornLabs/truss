// lib/commands/prompt.mjs — `truss prompt <save|delete> <id> [content]`
//
...
export async function runPrompt(root, argv) {
  ...
  if (!['save', 'delete'].includes(sub)) {
    console.error('Usage: truss prompt <save|delete> <id> [content]'); process.exit(1)
  }
  if (!validId(id)) {
